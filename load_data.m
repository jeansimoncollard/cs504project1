...
if c>1
    ...
    columNumberNDStart = inputdlg('For multiple dimension tests, please input the first column of the column range where the data is: (Input 4 if working with Data_for_PCA file, input 1 if working with 2d or 3d tests)',...
             'Column number', [1 50]);
    columNumberNDEnd = inputdlg('For multiple dimension tests, please input the last column of the column range where the data is: (Input 8 if working with Data_for_PCA file, input 2 if working with 2d tests and 3 if working with 3d tests)',...
             'Column number', [1 50]);
end
